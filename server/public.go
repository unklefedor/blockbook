...
func (s *PublicServer) ConnectFullPublicInterface() {
	...
	serveMux.HandleFunc(path+"api/last-blocks/", s.jsonHandler(s.apiBlocks, apiDefault))
	// v2 format
	serveMux.HandleFunc(path+"api/v2/last-blocks/", s.jsonHandler(s.apiBlocks, apiV2))
